...
//////////////////////////////////////////New Functions /////////////////////////////////////////////////
    ...
    // // downsampling lidar point clouds
    ...
    // int getDivideNumber(float length){return std::max(2, (int)(15/length));}
...
int main(int argc, char** argv)
{
    ...
    float gamma = 0.9f; // decaying factor for prediction update
    ...
    float prior_all = 0.0f; // dummy for compatability with ds-k3dom
